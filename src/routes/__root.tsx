...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Plataforma de Doação — Plataforma de Gestão" },
      { name: "description", content: "Plataforma de Doação: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
      { property: "og:title", content: "Plataforma de Doação — Plataforma de Gestão" },
      { name: "twitter:title", content: "Plataforma de Doação — Plataforma de Gestão" },
      { property: "og:description", content: "Plataforma de Doação: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
      { name: "twitter:description", content: "Plataforma de Doação: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
